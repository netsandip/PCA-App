...
mainApp.controller('adverseDataEntryCtrl', ['$rootScope', '$scope', '$state', '$http', '$ionicPopover', function ($rootScope, $scope, $state, $http, $ionicPopover) {
    ...
    $http.get('json/adversedata.json')

                .success(function (data) {
                    $scope.adverseDetails = data; // binding the data to the $scope variable
                })
