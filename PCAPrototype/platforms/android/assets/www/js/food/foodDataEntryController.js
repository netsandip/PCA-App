mainApp.controller('foodDataEntryCtrl', ['$rootScope', '$scope', '$state', '$http', '$ionicPopover', function ($rootScope, $scope, $state, $http, $ionicPopover) {
    ...
    $http.get('json/fooddata.json')

                .success(function (data) {
                    $scope.foodDetails = data; // binding the data to the $scope variable
                })
