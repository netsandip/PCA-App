...
mainApp.controller('insulinDataEntryCtrl', ['$rootScope', '$scope', '$state', '$http', '$ionicPopover', function ($rootScope, $scope, $state, $http, $ionicPopover) {
    ...
    $http.get('json/insulindata1.json') 

                .success(function (data) {
                    $scope.insulinDetails = data; // binding the data to the $scope variable
                })
